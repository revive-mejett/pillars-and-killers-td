...
export class Missile extends Projectile {
    ...
    fire(deltaTime : number, enemies :Enemy[]) {
        ...
        eventDispatcher.fireEvent("towerAttackSoundPlay", {path: "assets/sounds/sfx/missile_whoosh.mp3", maxSources: 12, towerName: "Missile Launcher", volume: 1, speed: this.soundPitch})
    ...
    onImpact(enemies : Enemy[], impactPosition : Position) {
        ...
        eventDispatcher.fireEvent("towerAttackSoundPlay", {path: "assets/sounds/sfx/missile_boom.mp3", maxSources: 12, towerName: "Missile Pillar", volume: 1, speed: this.soundPitch})
