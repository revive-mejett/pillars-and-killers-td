        ...
        const onTick = () => {
            ...
            if (cooldown <= 0) {
                ...
                if (this.targetedEnemy) {
                    const beam = new CyroBeam(this.getCenterPosition().x, this.getCenterPosition().y, 5, 5, this.targetedEnemy, this.damage, this.speedMultiplier, 0xCC99FF, this.beamWidth, this.soundPitch, this.impactRadius)
